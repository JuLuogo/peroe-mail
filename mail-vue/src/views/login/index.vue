<template>
  <div id="login-box" :style=" background ? 'background: var(--el-bg-color)' : ''" v-loading="oauthLoading" :element-loading-text="$t('oauthLoggingIn')">
    ...
    <el-dialog class="bind-dialog" v-model="showBindForm"  :title="$t('oauthBindEmail')" >
